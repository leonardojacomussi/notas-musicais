...
from notas_musicais import escala, triade
...
def _triade_na_escala(nota: str, notas_da_escala: list[str]) -> str:
    ...
    if terca in notas_da_escala and quinta in notas_da_escala:
        return tonica
    elif terca not in notas_da_escala and quinta in notas_da_escala:
        return f'{tonica}m'
    elif terca not in notas_da_escala and quinta not in notas_da_escala:
        return f'{tonica}°'
